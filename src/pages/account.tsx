      ...
      <div className="flex flex-col gap-4 px-4 pt-6 pb-24">
        <div className="flex items-center gap-4">
          <div className="w-[75px] h-[75px] rounded-full overflow-hidden border border-gray-300">
            <Image
              src={user.photo_url || `/icons/avatar${Math.floor(Math.random() * 11) + 1}.svg`}
              alt="avatar"
              width={75}
              height={75}
              unoptimized
        ...
        <div className="text-[14px] text-[#171A1F] font-semibold">{t('your_wallet_address')}:</div>
